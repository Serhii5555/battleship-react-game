...
Battleship Game ("we," "us," "our," or "Company") is committed to protecting your privacy and ensuring transparency about how we collect, use, and protect your personal data. This Privacy Policy explains our cookie practices and your rights under GDPR.

## 1. Cookie Categories

### 1.1 Necessary Cookies (Required)
...
**Legal Basis:** Legitimate Interest / Technical Necessity (Article 6(1)(f) GDPR)

### 1.2 Functional Cookies (Optional)
...
### 1.3 Analytics Cookies (Optional)
...
### 1.4 Marketing Cookies (Optional)
...
- Withdraw your consent at any time by clearing your cookies or visiting our cookie preferences

## 4. Data Protection and Security

We implement appropriate technical and organizational measures to protect your personal data against unauthorized or unlawful processing, accidental loss, destruction, or damage. Security measures include:
...
- **Third-party ad networks** - for advertising (if marketing cookies accepted)
- **Content Delivery Networks** - for performance

These third parties have their own privacy policies and data processing terms.

## 8. Cookie Preferences

You can manage your cookie preferences in the following ways:

1. **Cookie Banner** - Use the cookie consent banner at the bottom of the page
2. **Settings Modal** - Click "Settings" in the cookie banner to customize preferences
3. **Browser Settings** - Disable cookies in your browser settings
4. **Clear Cookies** - Clear cookies from your browser at any time

## 9. Children's Privacy

Our website is not intended for children under the age of 13. We do not knowingly collect personal information from children. If we become aware that we have collected personal data from a child, we will take steps to delete such information promptly.
...
If you have questions about this Privacy Policy, your privacy, or to exercise any of your GDPR rights, please contact us at:

**Email:** privacy@battleship-game.example.com  
**Address:** [Your Company Address]  
**Data Protection Officer:** dpo@battleship-game.example.com

## 12. Legal Basis for Processing

We process your personal data based on the following legal bases:

- **Article 6(1)(a) GDPR:** Your explicit consent (for optional cookies)
- **Article 6(1)(f) GDPR:** Our legitimate interests (for necessary cookies and analytics)
- **Article 6(1)(b) GDPR:** Contractual necessity (for user accounts, if applicable)

## 13. Data Processing Agreement

If we work with third-party data processors, we have executed Data Processing Agreements (DPA) as required by Article 28 GDPR to ensure they process personal data only on our instructions and subject to a duty of confidentiality.
